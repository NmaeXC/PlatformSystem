...
//返回该条请假单的详细信息
$sql = "SELECT expense_item_type.value type, amount, site, remark, date, attachment FROM expense_item, expense_item_type WHERE expense_item.id = '{$expenseId}' AND expense_item.type = expense_item_type.id order by date";
$rs_sql = $mysqli -> query($sql);
